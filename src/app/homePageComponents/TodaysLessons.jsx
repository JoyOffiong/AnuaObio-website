...
function Lessons() {
  ...
  const lessons = [
    { img: image2, title: "Remember your Spiritual Heritage", date: "Jan. 10, 2025", bibleTexts: "Act 9:15; 2 Tim 1:3; 1 Cor. 4:17", link: "/pages/teaching/spiritual-heritage" },
    { img: image, title: "God’s grace is sufficient for our needs", date: "Jan. 10, 2025", bibleTexts: "2 Cor. 12:7-10; 1 Cor. 15:10", link: "/pages/teaching/grace" },
  ];
              ...
              <div key={index} className="px-6 md:px-32 mx-auto items-center gap-4">
                ...
                <div className="flex flex-col md:flex-col lg:flex-row my-10 gap-4 md:gap-16">
                  ...
                  <div className="space-y-2 w-full md:w-6/12">
                    <p className="md:text-5xl text-2xl leading-tight font-bold">{title}</p>
                    <p className="md:w-1/2 w-full text-2xl leading-tight font-bold">{date}</p>
                    <p className="md:w-2/3 w-full leading-tight text-2xl font-medium text-[#888888]">{bibleTexts}</p>
                    <div className="mt-2">
