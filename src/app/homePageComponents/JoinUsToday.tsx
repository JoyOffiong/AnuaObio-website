...
function JoinUsToday({}: Props) {
  return (
    <div className="grid my-20 items-center w-full space-x-24 md:gap-0 gap-y-6  md:grid-cols-2">
      <div
        className="bg-cover bg-center md:rounded-tr-2xl md:rounded-br-2xl relative z-10 font-sans"
        style={{
  ...
  <p className="text-[#333333] font-bold text-center md:text-left text-5xl leading-tight">
        ...
        <p className=" text-2xl leading-normal font-medium text-[#888888] md:w-10/12 text-wrap">
