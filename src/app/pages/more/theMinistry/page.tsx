    ...
    <div className="font-inter mt-16">
      <div className="px-4 md:px-16 py-16">
        ...
        <div className="md:space-y-24 space-y-12">
          <div className="flex flex-row items-center space-y-4 w-full md:w-1/2  mx-auto">
              <div className="">
          <p className="text-[#333333] md:w-2/3 w-full text-left text-lg md:text-xl">
          ...
          <div className="space-y-4 w-10/12 mx-auto space-y-10 justify-center md:w-2/3">
