...
const lessons = [
  {
    img: Bible,
    title: "Jesus and the Mosaic Law",
    date: "October 12th, 2025",
    bibleTexts: "Matt. 5:17-48",
    by:"Min. E.O. Akpan", 
    link: "./Jesus-and-the-mosaic-law",
  },
    {
    img: Bible,
    title: "Life at the crossroads",
    date: "October 19th, 2025",
    bibleTexts: "Matt. 7:13-14",
    by:"Min. E.O. Akpan", 
    link: "./Life-at-the-crossroads",
  },
];
function TeachingsOnTheMount({}: Props) {
  return (
...
THE TEACHING OF JESUS ON THE MOUNT.          </p>
        </div>
        <div className="">
...
export default TeachingsOnTheMount;
